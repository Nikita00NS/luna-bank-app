...
export default function AdminScreen() {
  ...
  return (
    <div className="page safe-top">
      <div className="px-4 py-3"><p className="text-base font-semibold">Admin Panel</p></div>
      <div className="px-4 mt-2 grid grid-cols-2 gap-3">
        ...
        <div className="card p-4"><p className="text-xs text-[var(--text-tertiary)]">Revenue</p><p className="text-2xl font-bold mono mt-1">${stats.revenue.toFixed(0)}</p></div>
      </div>
