...
import {
  ...
  ChevronRightIcon, QrCodeIcon, PaletteIcon,
...
export default function ProfileScreen() {
  ...
  const menuItems: { icon: React.ComponentType<any>; label: string; desc: string; page: Page }[] = [
  ...
  if (user.role === 'owner' || user.role === 'admin') {
    menuItems.push({ icon: SettingsIcon, label: 'Админ-панель', desc: '', page: 'admin' });
  }
