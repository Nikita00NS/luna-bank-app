...
export const ACCOUNT_TYPES = [
  {
    ...
    desc: 'Основной расчётный счёт в Luna Coin',
  },
  {
    id: 'business',
    name: 'Бизнес & Merchant API',
    currency: 'LNC',
    icon: '💼',
    requiresWallet: false,
    desc: 'Приём крипто-платежей с сайта, бота или магазина',
  },
  {
    id: 'ton',
    name: 'TON Network',
